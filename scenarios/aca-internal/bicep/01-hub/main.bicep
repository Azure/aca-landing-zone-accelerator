...
param hubResourceGroupName string = '${prefix}rg-hub${suffix}'
...
param hubVNetName string = '${prefix}vnet-hub-${uniqueString(subscription().id)}${suffix}'
...
param bastionName string = '${prefix}bas-${uniqueString(subscription().id)}${suffix}'
...
param bastionNSGName string = '${prefix}nsg-bas-${uniqueString(subscription().id)}${suffix}'
...
param bastionPublicIpName string = '${prefix}pip-bas-${uniqueString(subscription().id)}${suffix}'
...
param vmName string = '${prefix}vm-jumpbox-${uniqueString(subscription().id)}${suffix}'
...
param vmNSGName string = '${prefix}nsg-jumpbox-${uniqueString(subscription().id)}${suffix}'
