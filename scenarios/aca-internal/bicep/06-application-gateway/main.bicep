...
param applicationGatewayName string = 'agw-${workloadName}-${environmentName}-${locationShortName}'
...
param applicationGatewayPublicIpName string = 'pip-agw-${workloadName}-${environmentName}-${locationShortName}'

@description('The name of the user assigned identity to use for Application Gateway.')
param applicationGatewayUserAssignedIdentityName string = 'id-agw-${workloadName}-${environmentName}-${locationShortName}'
