...
module hubrg '../shared/bicep/modules/resource-group/rg.bicep' = {
  name: hubRgName
  params: {
    rgName: hubRgName
    location: location
...
//Create Hub Vnet
module vnethub '../shared/bicep/modules/vnet/vnet.bicep' = {
...
module publicipbastion '../shared/bicep/modules/vm/public-ip.bicep' = if (deployBastion) {
  scope: resourceGroup(hubrg.name)
...
module bastion '../shared/bicep/modules/vm/bastion.bicep' = if (deployBastion) {
  scope: resourceGroup(hubrg.name)
  name: 'bastion'
  params: {
    location: location
...
module jumpbox '../shared/bicep/modules/vm/virtual-machine.bicep' = if (jumpboxOsType == 'linux') {
  scope: resourceGroup(hubrg.name)
  name: 'jumpbox'
  params: {
    location: location
...
module vm_jumpboxwinvm '../shared/bicep/modules/vm/create-vm-windows.bicep' = if (jumpboxOsType == 'windows') {
  name: 'vm-jumpbox'
  scope: resourceGroup(hubrg.name)
  params: {
    location: location
...
module spokerg '../shared/bicep/modules/resource-group/rg.bicep' = {
  name: spokeRgName
  params: {
    rgName: spokeRgName
    location: location
...
module vnetspoke '../shared/bicep/modules/vnet/vnet.bicep' = {
...
module nsgacasubnet '../shared/bicep/modules/vnet/aca-nsg.bicep' = {
  scope: resourceGroup(spokerg.name)
  name: nsgAcaName
  params: {
    location: location
...
module nsggwsubnet '../shared/bicep/modules/vnet/app-gw-nsg.bicep' = {
  scope: resourceGroup(spokerg.name)
  name: 'nsggwsubnet'
  params: {
    location: location
...
module vnetpeeringhub '../shared/bicep/modules/vnet/vnet-peering.bicep' = {
  scope: resourceGroup(hubrg.name)
  name: 'vnetpeeringhub'
  params: {
...
module vnetpeeringspoke '../shared/bicep/modules/vnet/vnet-peering.bicep' = {
  scope: resourceGroup(spokerg.name)
 ...
 module privatednsACRZone '../shared/bicep/modules/vnet/private-dns-zone.bicep' = {
  scope: resourceGroup(spokerg.name)
...
module privateDNSLinkACR '../shared/bicep/modules/vnet/private-dns-link.bicep' = {
  scope: resourceGroup(spokerg.name)
...
module privateDNSLinkACRspoke '../shared/bicep/modules/vnet/private-dns-link.bicep' = {
  scope: resourceGroup(spokerg.name)
...
module privatednsVaultZone '../shared/bicep/modules/vnet/private-dns-zone.bicep' = {
  scope: resourceGroup(spokerg.name)
...
module privateDNSLinkVault '../shared/bicep/modules/vnet/private-dns-link.bicep' = {
  scope: resourceGroup(spokerg.name)
...
module privateDNSLinkVaultspoke '../shared/bicep/modules/vnet/private-dns-link.bicep' = {
  scope: resourceGroup(spokerg.name)
...
module updateACANSG '../shared/bicep/modules/vnet/subnet.bicep' = {
scope: resourceGroup(spokerg.name)
  name: 'updateNSG'
  params: {
...
module updateGWNSG '../shared/bicep/modules/vnet/subnet.bicep' = {
  scope: resourceGroup(spokerg.name)
  name: 'updateGWNSG'
  params: {
...
module acr '../shared/bicep/modules/acr/acr.bicep' = {
  scope: resourceGroup(spokerg.name)
  name: acrName
  params: {
    location: location
...
module privateEndpointKeyVault '../shared/bicep/modules/vnet/private-endpoint.bicep' = {
  scope: resourceGroup(spokerg.name)
...
module privateEndpointAcr '../shared/bicep/modules/vnet/private-endpoint.bicep' = {
  scope: resourceGroup(spokerg.name)
...
module privateEndpointACRDNSSetting '../shared/bicep/modules/vnet/private-dns.bicep' = {
  scope: resourceGroup(spokerg.name)
  name: 'acr-pvtep-dns'
  params: {
...
module privateEndpointKVDNSSetting '../shared/bicep/modules/vnet/private-dns.bicep' = {
  scope: resourceGroup(spokerg.name)
  name: 'kv-pvtep-dns'
  params: {
...
module acaIdentity '../shared/bicep/modules/identity/user-assigned.bicep' = {
  scope: resourceGroup(spokerg.name)
  name: 'acaIdentity'
  params: {
    location: location
...
module acalaworkspace '../shared/bicep/modules/laworkspace/la.bicep' = {
  scope: resourceGroup(spokerg.name)
  name: 'acalaworkspace'
  params: {
    location: location
...
module acaApplicationInsights '../shared/bicep/modules/app-insights/ai.bicep' = if (deployApplicationInsightsDaprInstrumentation) {
  scope: resourceGroup(spokerg.name)
  name: 'acaAppInsights'
  params: {
...
module containerAppEnvironment '../shared/bicep/modules/aca/container-app-env.bicep' = {
  scope: resourceGroup(spokerg.name)
   name: 'ACA-env-Deploy'
    params: {
...
module acracaaccess '../shared/bicep/modules/identity/acr-role.bicep' = {
  scope: resourceGroup(spokerg.name)
  name: 'acracaaccess'
  params: {
...
module keyvaultAccessPolicy '../shared/bicep/modules/keyvault/keyvault-access.bicep' = {
  scope: resourceGroup(spokerg.name)
...
module acadnszone '../shared/bicep/modules/vnet/private-dns-zone.bicep' = {
  scope: resourceGroup(spokerg.name)
...
module privateDNSLinkACAHub '../shared/bicep/modules/vnet/private-dns-link.bicep' = {
  scope: resourceGroup(spokerg.name)
...
module privateDNSLinkACAspoke '../shared/bicep/modules/vnet/private-dns-link.bicep' = {
  scope: resourceGroup(spokerg.name)
...
module record '../shared/bicep/modules/vnet/a-record.bicep' = {
  scope: resourceGroup(spokerg.name)
