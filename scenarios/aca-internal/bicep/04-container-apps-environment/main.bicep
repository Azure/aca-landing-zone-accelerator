...
param containerAppsEnvironmentName string = 'cae-${workloadName}-${environmentName}-${locationShortName}'

@minLength(4)
@maxLength(63)
@description('Optional. The name of the log analytics workspace. If set, it overrides the name generated by the template.')
param logAnalyticsWorkspaceName string = 'log-${workloadName}-${environmentName}-${locationShortName}'
...
param applicationInsightName string = 'appi-${workloadName}-${environmentName}-${locationShortName}'
