...
![Fine Collection Service](media/speed-trap-overview.png)
...
![Fine Collection Service - Sequence Diagram](media/fine-collection-sequence-diagram.png)



## Deployment

1. Architecture of the sample app
   1. 
  ### Dapr Components
